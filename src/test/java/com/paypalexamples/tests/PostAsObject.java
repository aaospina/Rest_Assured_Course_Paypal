...
public class PostAsObject extends BaseClass {
    ...
    public void createAPayment(){
        ...
        red_url.setCancel_url("http://www.hawai.com");
        ...
        shipping_address.setPhone("516516565");
        ...
        item2.setDescription("Brown color hat");
        item2.setName("hat");
        item2.setPrice("3");
        item2.setQuantity("5");
        item2.setSku("1");
        ...
        transaction.setDescription("This is a new transaction");
        transaction.setInvoice_number("463651465");
        ...
        postObject.setNote_to_payer("This is a simple note");
        postObject.setIntent("sale");
        postObject.setPayer(payer);
        postObject.setRedirect_urls(red_url);
        postObject.setTransactions(transactions);
